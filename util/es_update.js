...
// // https://search-test-fgypv7kxdooaoonkau4ajv734i.ap-northeast-1.es.amazonaws.com/_search?q=%E5%A4%A7%E5%AE%89
...
// let client = new Client({ node: 'https://search-test-fgypv7kxdooaoonkau4ajv734i.ap-northeast-1.es.amazonaws.com/_search?q=%E5%A4%A7%E5%AE%89' });
...
var domain = 'search-test-fgypv7kxdooaoonkau4ajv734i.ap-northeast-1.es.amazonaws.com'; // e.g. search-domain.region.es.amazonaws.com
var index = 'node-togather';
var type = '_doc';

function queryDocument(keyword, id) {
    ...
    request.path += index + '/' + type + '/' + 'FvVfPn0Bn1tmOyzUlv6U' + '/_update';
...
async function gatheringQueryresult(keyword) {
    ...
    for (let i in result.hits.hits) {
        ...
        console.log('result', result.hits.hits[i])
    }
...
let keyword = "https://cdn.eatgether.com/meetup/d469317f-506d-4cb4-81dc-f7bb7e3ffeb5/cover/bc5d6e18-4325-481b-b3b4-8cc824200dde.jpg"

let id = "FvVfPn0Bn1tmOyzUlv6U"

gatheringQueryresult(keyword, id)
